            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row hidden-xs">
                        <div class="col-sm-6">{{ $t('mealName') }}</div>
                        <div class="col-sm-2">{{ $t('starts') }}</div>
                        <div class="col-sm-2">{{ $t('ends') }}</div>
                    ...
                    <template v-for="(def, index) in definitions">
                        <div class="row meal-row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-sm btn-danger" @click="removeMeal(index)">{{ $t('delete') }}</button>
                            </div>
                        </div>
