const fi = {
    ...
    informationUpdated: 'Tiedot haettu',
    ...
    noNutritionGoals: 'Ei tavoitteita',
    ...
    reportBug: 'Ilmoita',
    reps: 'Toistot',
    resetPasswordRequestSuccess: 'Linkki salasanan vaihtamiseksi on lähetetty sähköpostiisi',
    resetPasswordSuccess: 'Salasana on nyt vaihdettu',
    restDay: 'Lepopäivä',
    restDayAbbr: 'Lepo',
    restDayShort: 'L',
    restore: 'Palauta',
    ...
    sendPasswordResetRequest: 'Lähetä salasanan nollauslinkki',
    september: 'Syyskuu',
    set: 'Sarja',
    sets: 'Sarjat',
    sleep: 'Uni',
