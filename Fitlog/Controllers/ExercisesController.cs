...
namespace Fitlog.Web.Controllers
{
    ...
    public class ExercisesController : ApiControllerBase
    {
        ...
        public IActionResult List()
        {
            ...
            var response = Mapper.Map<ExerciseDetailsResponse[]>(exercises);
            return Ok(response);
        }
        [HttpGet("search")]
        ...
        public IActionResult Details(Guid id)
        {
            ...
            var response = Mapper.Map<ExerciseDetailsResponse>(exercise);
        ...
        {
            var exercise = Mapper.Map<ExerciseDetails>(request);
        ...
        public IActionResult GetHistory(Guid exerciseId, DateTimeOffset start, DateTimeOffset end)
        {
            ...
            var response = Mapper.Map<List<ExerciseHistoryResponse>>(oneRepMaxHistory);
