...
using Fitlog.External.Foodie;
using System.Threading;
using Fitlog.External.KRuoka;
using Fitlog.External;
using AutoMapper;
...
namespace Fitlog.Web.Controllers
{
    ...
    public class FoodsController : ApiControllerBase
    {
        ...
        public IActionResult List()
        {
            ...
            var response = Mapper.Map<FoodSummaryResponse[]>(foods);
            return Ok(response);
        }
        [HttpGet("search")]
        [AllowAnonymous]
        ...
        public IActionResult SearchMostNutrients(int nutrientId, int? count)
        {
            ...
            var response = Mapper.Map<FoodSearchNutrientResultResponse[]>(foods);
            return Ok(response);
        }
