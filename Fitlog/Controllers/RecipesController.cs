...
namespace Fitlog.Web.Controllers
{
    ...
    public class RecipesController : ApiControllerBase
    {
        ...
        public RecipesController(INutritionRepository nutritionRepository, ILogRepository logger, IMapper mapper) : base(logger, mapper)
        {
        ...
        public IActionResult List()
        {
            ...
            var response = Mapper.Map<RecipeSummaryResponse[]>(recipes);
            return Ok(response);
        }
        [HttpGet("{id}")]
        public IActionResult Details(Guid id)
        {
            ...
            var result = Mapper.Map<RecipeDetailsResponse>(food);
            return Ok(result);
        }
        [HttpPost("")]
