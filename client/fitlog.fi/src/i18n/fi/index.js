export default {
    ...
    follow: 'Seuraa',
    food: 'Ruoka-aine',
    foodComparison: 'Ruoka-ainevertailu',
    ...
    search: 'Haku',
    secondaryMuscleGroups: 'Avustavat lihasryhmät',
    select: 'Valitse',
    selectActivity: 'Valitse toiminta',
    selectExercise: 'Valitse liike',
    selectFood: 'Valitse ruoka-aine',
    self: 'Oma',
    september: 'Syyskuu',
    set: 'Sarja',
    settings: 'Asetukset',
    ...
    title: 'Otsikko',
    today: 'Tänään',
    toExercise: 'Uusi liike',
    top100: 'Top 100',
    total: 'Yhteensä',
    training: 'Treenaus',
    trainingGoals: 'Treenitavoitteet',
    transfer: 'Siirrä',
    transferData: 'Siirrä tiedot',
    transferExerciseData: 'Siirrä liikkeen tiedot',
    transfer1rm: 'Korvaa maksimituloksissa',
    transferRoutines: 'Korvaa ohjelmissa',
    transferSuccessful: 'Tiedot siirretty',
    transferWorkouts: 'Korvaa treeneissä',
    tuesday: 'Tiistai',
    tuesdayAbbr: 'Ti',
    tuesdayShort: 'T',
    unit: 'Yksikkö',
