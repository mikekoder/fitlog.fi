import { QTabs,QTab,QTabPane,QField,QInput,QScrollArea,QSearch,QAutocomplete,QSelect,QBtn,QModal,QList,QItem,QDatetime, QFab, QFabAction, QTooltip } from 'quasar'
...
export default {
  ...
  components: {
        QTabs,QTab,QTabPane,QField,QInput,QScrollArea,QSearch,QAutocomplete,QSelect,QBtn,QModal,QList,QItem,QDatetime, QFab, QFabAction, QTooltip 
    },
    computed: {
    },
  methods: {
