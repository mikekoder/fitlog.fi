import { QTabs,QTab,QTabPane,QField,QInput,QScrollArea,QSearch,QAutocomplete,QSelect,QBtn,QModal,QList,QItem, QFab, QFabAction, QTooltip } from 'quasar'
...
export default {
    components: {
        QTabs, QTab, QTabPane, QField, QInput, QScrollArea, QSearch, QAutocomplete, QSelect, QBtn, QModal, QList, QItem,QFab, QFabAction, QTooltip 
    },
    data () {
        return {
            tab: 'tab-0',
                        ...
                        self.workouts = routine.workouts.map(w => {
                            return {
                                ...
                                exercises: w.exercises.map(we => {
                                    var exercise = exercises.find(e => e.id === we.exerciseId);
                                    return {
                                        exercise: exercise,
