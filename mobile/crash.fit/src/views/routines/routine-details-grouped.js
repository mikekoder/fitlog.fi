import { QTabs,QTab,QTabPane,QField,QInput,QScrollArea,QSearch,QAutocomplete,QSelect,QBtn,QModal,QList,QItem, QFab, QFabAction, QTooltip, QCard,QCardTitle,QCardMain,QCardActions,QCardSeparator } from 'quasar'
...
export default {
    components: {
        QTabs, QTab, QTabPane, QField, QInput, QScrollArea, QSearch, QAutocomplete, QSelect, QBtn, QModal, QList, QItem,QFab, QFabAction, QTooltip, QCard,QCardTitle,QCardMain,QCardActions,QCardSeparator
    },
    data () {
        return {
            tab: 'tab-0',
