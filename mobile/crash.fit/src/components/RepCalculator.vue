  ...
  <div>
    <div class="row">
        ...
        <div class="col-3" style="padding: 15px 10px;">
          <q-btn @click="calculate">{{ $t('calculate') }}</q-btn>
        </div>
      </div>
                <div class="row">
                    <div class="col-sm-12">
...
<script>
import { QIcon,QCard,QCardTitle,QCardMain,QCardActions,QCardSeparator,QModal,QBtn,QTabs,QTab,QTabPane,QScrollArea,QFab,QFabAction,QContextMenu, QItem,QDatetime,QField, QInput } from 'quasar'
...
export default {
  ...
  components:{
    QIcon,QCard,QCardTitle,QCardMain,QCardActions,QCardSeparator, QModal,QBtn,QTabs,QTab,QTabPane,QScrollArea,QFab,QFabAction,QContextMenu, QItem,QDatetime ,QField, QInput
  },
  computed: {
  },
  methods: {
